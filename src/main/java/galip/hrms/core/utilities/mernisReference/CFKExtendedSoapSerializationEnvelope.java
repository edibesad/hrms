...
public class CFKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CFKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CFKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CFKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CFKDateTimeConverter dateTimeConverter = new CFKStandardDateTimeConverter();

    public CFKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CFKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CFKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CFKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CFKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CFKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
