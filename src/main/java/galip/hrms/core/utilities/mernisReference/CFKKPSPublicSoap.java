...
public class CFKKPSPublicSoap
{
    ...
    public CFKKPSPublicSoap(){}

    public CFKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CFKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CFKExtendedSoapSerializationEnvelope envelope= new CFKExtendedSoapSerializationEnvelope(CFKExtendedSoapSerializationEnvelope.VER11);
